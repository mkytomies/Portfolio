...
describe('Portfolio page', () => {
    ...
    test('github links point to correct URL', () => {
        ...
        const pGithhubLink = within(portfolioProject).getByRole('link', { name: /github/i });
        ...
        expect(pGithhubLink).toHaveAttribute('href', 'https://github.com/mkytomies/Portfolio');
    ...
    test('figma links point to correct URL', () => {
        ...
        const pFigmaLink = within(portfolioProject).getByRole('link', { name: /figma/i });
        ...
        expect(pFigmaLink).toHaveAttribute('href', 'https://www.figma.com/community/file/1623305769059810923/portfolio');
    ...
    test('user can navigate project tile buttons with keyboard', async () => {
        ...
        within(portfolioProject).getByRole('link', { name: /github/i }).focus();
        await userEvent.tab();
