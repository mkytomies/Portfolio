		...
		<>
			<div className="mainContainer">
				...
				<p className="bodyText">
					I am a soon-to-graduate software engineering student with a
					passion for web development. I have a background in media
					studies and work experience in creating websites, which has
					strengthened both my visual and technical skills. I enjoy
					building practical digital solutions and learning new tools.
				</p>
				...
				<p className="bolded">
					Design Kumina, Lahti | 11 / 2018 - 05 / 2023{' '}
				</p>
				...
				<ul>
					...
					<li>
						Gained hands-on experience creating and maintaining
						websites, working in close collaboration with the
						designer
					</li>
				</ul>
			</div>
